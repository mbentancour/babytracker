...
-- SQLite requires dropping indexes that reference a column before the column
-- itself can be dropped (Postgres drops them automatically).
DROP INDEX IF EXISTS idx_photos_child_date;

ALTER TABLE photos DROP COLUMN child_id;
